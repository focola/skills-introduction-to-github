...
// 修改后的showDepartmentsAndMakeAppointment函数片段
void showDepartmentsAndMakeAppointment() {
    printf("\n=== 科室列表 ===\n");
    for(int i=0; i<departmentCount; i++){
    ...
    do {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            case 4:
                searchByDisease(mode);  // 统一调用函数，模式参数控制显示
                break;
            case 5:
